  ...
  return (
    ...
    <div className='flex justify-between mb-2'>
        ...
        <div className='flex gap-2'>
            <svg onClick={()=>openModal(todo)}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer">
    ...
    <EditModal  editTodo={editTodo} closeModal={closeModal}/>
</>
  )
}
